...
また私は、ゲームほど人を楽しませるのに、Enjoyさせることに特化したプログラムはないと思っています。現在の人々の娯楽の多くを占めているのも事実でしょう。
...
様々な資料にあたって、最終的に大衆の作る世界最大のフリー百科辞典Wikipediaを参考に次のような結論となりました。
...
ここで必要になるものとしてまず、把握しやすいようにまとめてキャラクターのパラメータを保持しておく必要があります。
...
そこで、マップを表示しスクロールさせる事になりますが、広大な世界を1枚の画像にしでそれをスクロールさせようとしたら、重くて仕方がありません。マップの情報を縦と横のマス目で区切って管理することになります。
